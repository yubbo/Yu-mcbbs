...
jQuery.noConflict();
function comiis_fixed_top_nv(eleid, disbind) {
		...
		if(this.openflag && this.nvdata.next){
			...
			if(dofixed) {
				if(this.nv.style.position != 'fixed') {
					...
					this.nv.style.height = (this.nvdata.height - 1) + 'px';
					this.nv.style.width = '100%';
					this.nv.style.top = '0';
					this.nv.style.left = this.nvdata.left + 'px';
					this.nv.style.position = 'fixed';
					this.nv.style.zIndex = '310';
					this.nv.style.boxShadow = '0 0 25px rgba(0,0,0,0.2)';
					this.nv.parentNode.style.height = (this.nvdata.height - 1) + 'px';
				}
			} else {
